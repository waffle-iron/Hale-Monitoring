...
INSERT INTO #uspDropList (Name) VALUES
	...
	, ('uspGetCheck')
	, ('uspListChecks')
	, ('uspGetCheckByIdentifier')

	-- Check Results
	, ('uspGetCheckResult')
	, ('uspDeleteCheckResult')
	, ('uspCreateCheckResult')
	, ('uspUpdateCheckResult')
	, ('uspListResultsForHostCheck')
...
BEGIN
	...
	BEGIN
		...
		EXEC(@dropSql);
		PRINT CAST(SYSDATETIME() AS NVARCHAR(19)) + ' - Dropped stored procedure ' + @currentName + ' from the database.'
	END
